...
const PopUp = ({display, hiddenPopup, addClasses, addClass, setClass, idUser, setIdUser }) => {



  return (
    <div className={`w-screen h-screen absolute top-[-20%] left-[-20%] bg-[#0000007d] ${display} flex justify-center pt-10`}>
        <form onSubmit={addClasses} className="card w-1/2 h-1/3 bg-white text-neutral-content p-10 shadow-xl rounded-xl text-alta-primary">
        ...
        onClick={() => hiddenPopup()}>✕</label>
            ...
            <div className="card-actions flex justify-end mt-5">
                ...
                <button type='submit' className="btn bg-alta-primary hover:bg-hover-primary text-white">Add Class</button>
            </div>
        </div>
        </form>
    </div> 
